export const HERO_CONTENT = "Building scalable, secure, and high-performance applications from code to cloud. Passionate about designing and deploying reliable cloud solutions using AWS and Azure, automating CI/CD pipelines, containerizing applications with Docker, implementing Infrastructure as Code (IaC), and delivering modern, resilient, and production-ready applications.";
